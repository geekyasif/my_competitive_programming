...
if __name__ == "__main__":
    ...
    while cmd:
        ...
        #         'US/East-Indiana']
            ...
            #     speak(f"The date of {Country_Zones[i]} is {country_time.strftime('%d-%m-%y')} and The time of {Country_Zones[i]} is {country_time.strftime('%H:%M:%S')}")
         ...
         speak("Kaif is full stack web developer...........,kaif ia a .....Divya's Lover")
            ...
            try:
                ...
                dic={
                    ...
                    "Golu" : "mishra.adarsh277@gmail.com",
                    "Hrithik":"hrithiky21@gmail.com"
